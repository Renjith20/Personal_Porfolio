...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_2fqspsj', 'template_zplvivp', formRef.current,'Cou3-lLGwoIfMpQ1C',
          )
          .then(
            () => {
             setSuccess(true);
    ...
    whileInView="animate">
        <motion.div className="textContainer" variants={variants}>
            ...
            <motion.div className="item" variants={variants}>
                <h2>Mail</h2>
                <span>renjithrp03@gmail.com</span>
            </motion.div>
            <motion.div className="item" variants={variants}>
                <h2>Address</h2>
                <span>Renjith Bhavan, <br /> Mandiram Kunnu, mathira p.o , Kollam ,<br /> Kerala , India <br />pincode : 691536</span>
            </motion.div>
            <motion.div className="item" variants={variants}>
                <h2>Phone</h2>
                <span>+91 9072712198</span>
            </motion.div>
         </motion.div>
